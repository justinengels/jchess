...
- Name: engine.spec.js >> Terminal States (Mate/Stalemate) >> Back-Rank Mate: isCheckmate() returns true when the King is trapped behind pawns and attacked by a Rook
- Location: tests/engine.spec.js:51:3
